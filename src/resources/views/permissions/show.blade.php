            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex align-items-center justify-content-between">
                        <h5 class="card-title mb-0">Permission Details: {{ $permission->name }}</h5>
                        <div>
                            <a href="{{ route('rp.permissions.edit', $permission->id) }}" class="btn btn-warning">
                                <i class="ri-pencil-line align-middle me-1"></i> Edit
                            </a>
                            <a href="{{ route('rp.permissions.index') }}" class="btn btn-secondary">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div>
                                ...
                                @empty
                                    <span class="text-muted">No roles have this permission</span>
                                @endforelse
                            </div>
                        </div>
                    </div>
